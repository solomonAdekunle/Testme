/**
 *  This Page is where all common properties are stored
 *  It a super class for the project
 * 
 * */
...
public class WebConnector {
		...
		if (OR == null) {
			try {
				...
				FileInputStream fs = new FileInputStream(
						System.getProperty("user.dir") + "\\src\\main\\java\\com\\Config\\OR.Properties");
				OR.load(fs);
	...
	// Select a text from a drop down box
