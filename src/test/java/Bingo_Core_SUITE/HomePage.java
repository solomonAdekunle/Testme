...
public class HomePage extends TestBase {
	...
	public void Headertest(Hashtable<String, String> table) throws IOException, InterruptedException {
		...
		// click on the Vernons Logo
		click("hp_VernonsBingoLogo_xpath");
		...
		Thread.sleep(2000);
		/*
		 * click("hp_HeaderHelpicon_xpath"); Thread.sleep(3000);
		 * Assert.assertEquals(d.getCurrentUrl(),
		 * "https://bingo.release.vernons.com/contact"); d.navigate().back();
		 * Thread.sleep(2000); boolean
		 * Chat=isElementPresent("hp-HeaderChatIcon_xpath");
		 * if(!isElementPresent("hp-HeaderChatIcon_xpath"))// verify if element
		 * is not present System.out.println(false); else
		 */
		...
		isElementPresent("chat_TextBox_xpath");
		// verify if Chat Box is lunched
		if (!isElementPresent("chat_TextBox_xpath"))
			// System.out.println(Chatbox);
			test.log(LogStatus.PASS, "Element not displayed");
		else
			// System.out.println(false);
			test.log(LogStatus.FAIL, "Element is displayed");
	...
	public void BingoVertcalMenutest(Hashtable<String, String> table) throws IOException, InterruptedException {
		...
		Assert.assertEquals(relativeURLY, "/bingo");// verify bingo Vertical tab
													// link navigate to the
													// right url
		// Thread.sleep(1000);
		// d.navigate().back();
		Thread.sleep(5000);
		...
		Assert.assertEquals(relativeURL1, "/timetable");// check if current url
														// is the same as the
														// expected
		Thread.sleep(2000);
		d.navigate().back();
		...
		Assert.assertEquals(relativeURL2, "/bingo-guide");// verify if the both
															// URL are equal
		Thread.sleep(2000);
		d.navigate().back();
		Thread.sleep(2000);
	...
	public void PromotionsVertcalMenutest(Hashtable<String, String> table) throws IOException, InterruptedException {
		...
		navigate("testsiteURL");
		Thread.sleep(2000);
		click("hp_promotionsVerticalTab_xpath");// click on promotion vertical
												// tab link
		...
		// Verify if the Casino VerticalTab link will navigate to Casino
		// Homepage
		d.navigate().back();
		Thread.sleep(2000);
	...
	public void HelpVertcalMenutest(Hashtable<String, String> table) throws IOException, InterruptedException {
		...
		Assert.assertEquals(relativeURL4, "/help/getting-started");// verify if
																	// the both
																	// URL are
																	// equal
		Thread.sleep(2000);
		...
		Assert.assertEquals(relativeURL5, "/banking");// verify if the both URL
														// are equal
		Thread.sleep(2000);
		d.navigate().back();
		Thread.sleep(2000);
		...
		Assert.assertEquals(relativeURL6, "/help/is-my-deposit-safe");// verify
																		// if
																		// the
																		// both
																		// URL
		...
		Assert.assertEquals(relativeURL7, "/help/bonus-use");// verify if the
																// both URL are
																// equal
		Thread.sleep(2000);
		d.navigate().back();
		...
		Assert.assertEquals(relativeURL8, "/help/depositing");// verify if the
																// both URL are
																// equal
		Thread.sleep(2000);
		d.navigate().back();
		...
		Assert.assertEquals(relativeURL9, "/help/prebuy");// verify if the both
															// URL are equal
		Thread.sleep(2000);
		d.navigate().back();
		Thread.sleep(2000);
		...
		Assert.assertEquals(relativeURL10, "/help/chat-hosts");// verify if the
																// both URL are
																// equal
		Thread.sleep(2000);
		d.navigate().back();
		...
		try {
			...
			Assert.assertEquals(relativeURL14, "/mobile");// verify if the both
															// URL are equal
		} catch (Throwable t) {
			t.getStackTrace();
		...
		Assert.assertEquals(relativeURL11, "/help/faq");// verify if the both
														// URL are equal
		Thread.sleep(2000);
		d.navigate().back();
		Thread.sleep(2000);
		...
		Assert.assertEquals(relativeURL12, "/contact");// verify if the both URL
														// are equal
		Thread.sleep(2000);
		// d.navigate().back();
	...
	public void Footertest(Hashtable<String, String> table) throws IOException, InterruptedException {
		...
		// Assert.assertEquals( relativeURL12 ,"/about-us");// verify if the
		// both URL are equal
		Thread.sleep(2000);
		d.navigate().back();
		Thread.sleep(2000);
		...
		Assert.assertEquals(d.getCurrentUrl(), "http://www.netplayaffiliates.com/");// verify
																					// if
																					// the
																					// both
																					// URL
		...
		Assert.assertEquals(relativeURL13, "/contact");// verify if the both URL
														// are equal
		Thread.sleep(2000);
		d.navigate().back();
		wat.until(ExpectedConditions
				.presenceOfElementLocated(By.cssSelector(OR.getProperty("hp_FooterResponsibleGambling_Selector"))));
		WebElement FooterResponsibleGamingSLink = d
				.findElement(By.cssSelector(OR.getProperty("hp_FooterResponsibleGambling_Selector")));
		((JavascriptExecutor) d).executeScript("arguments[0].click();", FooterResponsibleGamingSLink);
		try {
			Thread.sleep(2000);
			String relativeURL14 = TestBase.getRelativeUrl(d.getCurrentUrl());
			Assert.assertEquals(relativeURL14, "/enjoy-responsibly");// verify
																		// if
																		// the
																		// both
																		// URL
		...
		Assert.assertEquals(relativeURL15, "/help/faq");// verify if the both
														// URL are equal
		Thread.sleep(2000);
		d.navigate().back();
		wat.until(
				ExpectedConditions.presenceOfElementLocated(By.xpath(OR.getProperty("hp_FooterPrivacyPolicy_xpath"))));
		...
		Assert.assertEquals(relativeURL16, "/privacy-policy");// verify if the
																// both URL are
																// equal
		Thread.sleep(2000);
		d.navigate().back();
		wat.until(ExpectedConditions
				.presenceOfElementLocated(By.xpath(OR.getProperty("hp_FooterTerms&Conditions_xpath"))));
		...
		Assert.assertEquals(relativeURL17, "/terms-and-conditions");// verify if
																	// the both
																	// URL are
																	// equal
		Thread.sleep(2000);
		d.navigate().back();
		Thread.sleep(2000);
		// Verify if all Methods of payment icons are displayed within the the
		// footer
		...
		Thread.sleep(2000);
		boolean footertext = isElementPresent("hp_footerUKGCtext_Selector");// VERIFY
																			// IF
																			// UKGC
																			// TEXT
																			// IS
	...
	public void netplaytvicontest(Hashtable<String, String> table) throws IOException, InterruptedException {
		...
		WebDriverWait wat = new WebDriverWait(d, 20);
		wat.until(ExpectedConditions
				.presenceOfElementLocated(By.cssSelector(OR.getProperty("hp_footerNetplaytvIcon_Selector"))));
		WebElement FooterNetplaytvLink = d
				.findElement(By.cssSelector(OR.getProperty("hp_footerNetplaytvIcon_Selector")));
		...
		Thread.sleep(2000);
		wat.until(ExpectedConditions
				.presenceOfElementLocated(By.cssSelector(OR.getProperty("hp_footer18+Icon_Selector"))));
	...
	public void GamecareIcontest(Hashtable<String, String> table) throws IOException, InterruptedException {
		...
		WebDriverWait wat = new WebDriverWait(d, 20);
		wat.until(ExpectedConditions
				.presenceOfElementLocated(By.cssSelector(OR.getProperty("hp_footerGamcareIcon_Selector"))));
	...
	public void GamblingCommsionIcontest(Hashtable<String, String> table) throws IOException, InterruptedException {
		...
		WebDriverWait wat = new WebDriverWait(d, 20);
		wat.until(ExpectedConditions
				.presenceOfElementLocated(By.cssSelector(OR.getProperty("hp_footerGamblingCommissionIcon_Selector"))));
		WebElement FooterGamblingCommsiionLink = d
				.findElement(By.cssSelector(OR.getProperty("hp_footerGamblingCommissionIcon_Selector")));
		...
		try {
			Assert.assertEquals(d.getCurrentUrl(),
					"https://secure.gamblingcommission.gov.uk/gccustomweb/PublicRegister/PRAccountDetails.aspx?accountNo=39144");// verify
																																	// if
																																	// the
																																	// both
																																	// URL
	...
	public void GamblingwareIcontest(Hashtable<String, String> table) throws IOException, InterruptedException {
		...
		navigate("testsiteURL");
		WebDriverWait wat = new WebDriverWait(d, 20);
		wat.until(ExpectedConditions.presenceOfElementLocated(By.xpath(OR.getProperty("hp_footerGameCareIcon_xpath"))));
		WebElement GamCareFooterLink = d.findElement(By.xpath(OR.getProperty("hp_footerGameCareIcon_xpath")));
		((JavascriptExecutor) d).executeScript("arguments[0].click();", GamCareFooterLink);
		...
		// System.out.println(it.next());
		d.switchTo().window(tabbedWindowId3);// switch to the affiliates window
		Assert.assertEquals(d.getCurrentUrl(), "http://www.gamcare.org.uk/");// verify
																				// if
																				// the
																				// both
																				// URL
	...
	public void AlderneyIcontest(Hashtable<String, String> table) throws IOException, InterruptedException {
		...
		WebDriverWait wat = new WebDriverWait(d, 20);
		wat.until(ExpectedConditions
				.presenceOfElementLocated(By.cssSelector(OR.getProperty("hp_footerAlderneyIcon_Selector"))));
		WebElement AlderneyFooterLink = d.findElement(By.cssSelector(OR.getProperty("hp_footerAlderneyIcon_Selector")));
		((JavascriptExecutor) d).executeScript("arguments[0].click();", AlderneyFooterLink);
